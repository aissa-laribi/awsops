curl https://raw.githubusercontent.com/aissa-laribi/awsops/main/ec2/Backup-EC2-Instances-Daily/Prune-Snapshots/lambda_function.py > lambda_function.py
#Replace 'Enter_Region_Name' with your region
zip -9 lambda_function.zip lambda_function.py
aws iam list-roles | grep EC2Backup
aws lambda create-function --function-name Prune-Snapshots  --role <lambda-arn> \
